...
import numpy as np
from quarterTools import colors_for_plot, read_kepler_curve
import pandas as pd
...
fits_dir           = '/home/dgiles/Documents/KeplerLCs/fitsFiles/Q8fitsfiles/'
...
def update_plot():
    ...
    lcfs = list(s1.data['files'][inds])
    for i,ind in enumerate(inds):
        # for local data
        lcf = fits_dir+lcfs[i]
        new_t, new_nf, _ = read_kepler_curve(lcf)
        newdata = {'t':new_t,'nf':new_nf}
        """
        # for remote data
        lc = lcs[i]
